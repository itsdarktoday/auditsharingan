...
example PoC: /tmp/test-vault/AuditSharingan-audit/poc/withdraw-desync/Exploit.t.sol (forge test --match-test test_withdrawDesync → PASS; attacker profit 33%, victim claim permanently locked)
